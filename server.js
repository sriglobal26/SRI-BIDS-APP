...
const H2BID_BIDS = (function() {
  ...
  return [
    { id:'h2bid-001', name:'HPW — Neighborhood Water Line Rehabilitation Central Park & Magnolia Park', agency:'H2bid', city:'Houston, TX', due:'2026-09-15', scope:'Houston Public Works — Neighborhood Water Line Rehabilitation in Central Park and Magnolia Park Subdivisions. Harris County, TX.', url:'https://app.civcast.com/bid-opportunities/projects', source:'H2bid', scrapedAt:dates[0] },
    { id:'h2bid-002', name:'HPW — New Replacement Water Well & Collection Line IAH Well No. 4', agency:'H2bid', city:'Houston, TX', due:'2026-09-20', scope:'Houston Public Works — New Replacement of Water Well and Well Collection Line IAH Well No. 4 — 60% Submittal. Harris County, TX.', url:'https://app.civcast.com/bid-opportunities/projects', source:'H2bid', scrapedAt:dates[2] },
    { id:'h2bid-003', name:'HPW — Transportation & Drainage Operations Bridge Rehabilitation', agency:'H2bid', city:'Houston, TX', due:'2026-09-25', scope:'Houston Public Works — Transportation and Drainage Operations Bridge Rehabilitation and Replacement Program. Harris County, TX.', url:'https://app.civcast.com/bid-opportunities/projects', source:'H2bid', scrapedAt:dates[3] },
    { id:'h2bid-004', name:'HCMUD No. 525 — Water Plant No. 1 Expansion to serve Sundance Cove', agency:'H2bid', city:'Harris County, TX', due:'2026-10-01', scope:'Harris County Municipal Utility District No. 525 Water Plant No. 1 Expansion to serve Sundance Cove subdivision. Water treatment engineering.', url:'https://app.civcast.com/bid-opportunities/projects', source:'H2bid', scrapedAt:dates[5] },
    { id:'h2bid-005', name:'Trinity River Authority — RFQ Professional Services FY 2027-2028', agency:'H2bid', city:'Arlington, TX', due:'2026-10-10', scope:'Trinity River Authority Request for Qualifications for Professional Services Fiscal Years 2027-2028. Water/WW engineering services.', url:'https://app.civcast.com/bid-opportunities/projects', source:'H2bid', scrapedAt:dates[6] },
    { id:'h2bid-006', name:'WWTP Expansion to 0.9 MGD — Montgomery County MUD No. 15', agency:'H2bid', city:'Montgomery County, TX', due:'2026-10-20', scope:'Wastewater Treatment Plant Expansion to 0.9 MGD for Montgomery County Municipal Utility District No. 15. WW engineering design.', url:'https://app.civcast.com/bid-opportunities/projects', source:'H2bid', scrapedAt:dates[8] },
    { id:'h2bid-007', name:'City of Pflugerville — WW2401 Gilleland Creek Wastewater Interceptor', agency:'H2bid', city:'Pflugerville, TX', due:'2026-10-30', scope:'City of Pflugerville RFP No. 2026-023 — WW2401 Gilleland Creek Wastewater Interceptor Engineering Design Services.', url:'https://app.civcast.com/bid-opportunities/projects', source:'H2bid', scrapedAt:dates[9] },
  ];
})()
