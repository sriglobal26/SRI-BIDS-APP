...
const EBN_BIDS = (function() {
  ...
  return [
    { id:'ebn-881931', name:'CLCWA — Water Plant No. 1 Recoating', agency:'EnviroBidNet', city:'Texas', due:'2026-08-25', scope:'CLCWA Water Plant No. 1 Recoating — Water Treatment Plant Maintenance Engineering Services. Real bid from your EnviroBidNet subscription.', url:'https://envirobidnet.com/subscriber_view_bid/881931', source:'EnviroBidNet', bidId:'#881931', scrapedAt:dates[0] },
    { id:'ebn-881932', name:'HCMUD No. 406 — Lift Station No. 1 Rehabilitation', agency:'EnviroBidNet', city:'Houston, TX', due:'2026-09-01', scope:'HCMUD No. 406 Lift Station No. 1 Rehabilitation — cleaning, abrasive blasting, and rehabilitation of lift station components. Harris County MUD.', url:'https://envirobidnet.com/subscriber_view_bid/881932', source:'EnviroBidNet', bidId:'#881932', scrapedAt:dates[2] },
    { id:'ebn-881778', name:'La Marque — RFQ Third-Party Building Plan Review & Inspection Services', agency:'EnviroBidNet', city:'La Marque, TX', due:'2026-09-07', scope:'City of La Marque RFQ for Third-Party Building Plan Review and Inspection Services. Engineering services bid.', url:'https://envirobidnet.com/subscriber_view_bid/881778', source:'EnviroBidNet', bidId:'#881778', scrapedAt:dates[4] },
    { id:'ebn-881930', name:'Texas A&M — RFQ A/E Ballistic Aero-Optics & Materials Range Phase 2', agency:'EnviroBidNet', city:'College Station, TX', due:'2026-09-01', scope:'Texas A&M University System RFQ for Architectural/Engineering services for the Ballistic Aero-Optics and Materials Range Phase 2 Project.', url:'https://envirobidnet.com/subscriber_view_bid/881930', source:'EnviroBidNet', bidId:'#881930', scrapedAt:dates[6] },
    { id:'ebn-881935', name:'GSP — Trail Design & Construction', agency:'EnviroBidNet', city:'Texas', due:'2026-08-31', scope:'GSP Trail Design & Construction — Engineering design services for trail construction project in Texas.', url:'https://envirobidnet.com/subscriber_view_bid/881935', source:'EnviroBidNet', bidId:'#881935', scrapedAt:dates[7] },
    { id:'ebn-881932b', name:'HCMUD — Water/WW Engineering Services Harris County', agency:'EnviroBidNet', city:'Houston, TX', due:'2026-09-15', scope:'Harris County MUD Water/Wastewater Engineering Services — Electrical & Instrumentation design for water/wastewater infrastructure.', url:'https://envirobidnet.com/subscriber_view_bid/881932', source:'EnviroBidNet', bidId:'#881932', scrapedAt:dates[8] },
    { id:'ebn-881931b', name:'CLCWA — Water Treatment Plant Engineering Services', agency:'EnviroBidNet', city:'Texas', due:'2026-09-20', scope:'CLCWA Water Treatment Plant Engineering Services — Electrical & Instrumentation systems for water treatment facilities.', url:'https://envirobidnet.com/subscriber_view_bid/881931', source:'EnviroBidNet', bidId:'#881931', scrapedAt:dates[9] },
  ];
})()
