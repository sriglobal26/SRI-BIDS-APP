...
const H2BID_BIDS = [
  { id:'h2bid-001', name:'City of Houston — WW Collection System Rehab & Renewal CB-2026-0048', agency:'H2bid', city:'Houston, TX', due:'2026-09-15', dueTime:'2:00 PM CDT', posted:'2026-08-01', scope:'On-call rehab and renewal of wastewater collection system. Point repairs, sewer replacement, CIPP, manholes. Est. $4.3M. Houston Public Works.', url:'https://www.beaconbid.com/solicitations/city-of-houston/085f5cae-deb4-4ccd-aae0-d070ae461214/wastewater-collection-system-rehabilitation-and-renewal', source:'H2bid' },
  { id:'h2bid-002', name:'City of San Antonio — WW Treatment Plant Electrical & Instrumentation Upgrades', agency:'H2bid', city:'San Antonio, TX', due:'2026-09-20', posted:'2026-08-05', scope:'San Antonio Water System (SAWS) — Electrical and Instrumentation upgrades at wastewater treatment plant facilities. SCADA integration and controls engineering.', url:'https://www.saws.org/business-center/purchasing/', source:'H2bid' },
  { id:'h2bid-003', name:'City of Dallas — Water Reclamation Facility Electrical Engineering Services', agency:'H2bid', city:'Dallas, TX', due:'2026-09-25', posted:'2026-08-06', scope:'City of Dallas Water Utilities — Electrical engineering services for water reclamation facility improvements. Instrumentation, controls and SCADA systems upgrade.', url:'https://www.dallascityhall.com/departments/procurement/Pages/default.aspx', source:'H2bid' },
  { id:'h2bid-004', name:'City of Fort Worth — Water Department Lift Station Electrical Rehab', agency:'H2bid', city:'Fort Worth, TX', due:'2026-10-01', posted:'2026-08-10', scope:'City of Fort Worth Water Department — Lift Station Electrical Rehabilitation project. Motor control centers, VFDs, SCADA upgrades at multiple lift station locations.', url:'https://www.fortworthtexas.gov/departments/water', source:'H2bid' },
  { id:'h2bid-005', name:'City of Austin — WTP Electrical & Instrumentation Engineering Services', agency:'H2bid', city:'Austin, TX', due:'2026-10-10', posted:'2026-08-12', scope:'Austin Water — Water Treatment Plant Electrical & Instrumentation Engineering Services. SCADA system design, MV electrical, instrumentation upgrades for Ullrich and Davis WTPs.', url:'https://www.austintexas.gov/department/purchasing', source:'H2bid' },
  { id:'h2bid-006', name:'Trinity River Authority — Engineering Services Water/WW Facilities', agency:'H2bid', city:'Arlington, TX', due:'2026-10-20', posted:'2026-08-08', scope:'Trinity River Authority of Texas — Engineering services for water and wastewater treatment facilities. Electrical, instrumentation, SCADA and controls engineering design.', url:'https://www.civcastusa.com/publishers/5d6017908289a31a1c7febe1', source:'H2bid' },
  { id:'h2bid-007', name:'City of El Paso — Water Utilities Pump Station SCADA Engineering', agency:'H2bid', city:'El Paso, TX', due:'2026-10-30', posted:'2026-08-09', scope:'El Paso Water Utilities — Pump Station SCADA Engineering Services. PLC programming, SCADA integration, instrumentation design for water distribution pump stations.', url:'https://www.epwater.org/our_utility/procurement', source:'H2bid' },
];
