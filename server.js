...
const EBN_BIDS = (function() {
  ...
  return [
    ...
    { id:'ebn-881877', name:'HHSC — Lead Sample Analysis Services for Dept of Health Services', agency:'EnviroBidNet', city:'Austin, TX', due:'2026-09-21', scope:'Texas Health & Human Services Commission — Lead Sample Analysis Services for the Department of State Health Services. Austin, TX.', url:'https://envirobidnet.com/subscriber_view_bid/881877', source:'EnviroBidNet', bidId:'#881877', scrapedAt:dates[9] },
  ];
})()
...
const H2BID_BIDS = (function() {
  ...
  return [
    ...
    { id:'h2bid-002', name:'City of Houston — WW Collection System Rehab Manholes CB-2026-0030', agency:'H2bid', city:'Houston, TX', due:'2026-09-20', scope:'Rehab of existing manholes using cementitious liners, CIPP liners, polymeric coatings. Point repairs to sewer mains at manhole connections. Houston Public Works.', url:'https://www.beaconbid.com/solicitations/city-of-houston/9f2e4bf2-7d31-4ec1-943c-10f0eeec95d0/wastewater-collection-system-rehabilitation-and-renewal-of-manholes', source:'H2bid', scrapedAt:dates[2] },
    { id:'h2bid-003', name:'City of Houston — Sims North WWTP Improvements Package 3 CB-2026-0022', agency:'H2bid', city:'Houston, TX', due:'2026-09-25', scope:'Comprehensive mechanical and structural improvements at Sims North Wastewater Treatment Plant. Repair/replacement of mechanical systems, structural components, electrical building. Houston Public Works.', url:'https://www.beaconbid.com/solicitations/city-of-houston/d970dd10-3342-4999-b71c-c31d88edf5a8/sims-north-wastewater-treatment-plant-improvements-package', source:'H2bid', scrapedAt:dates[3] },
    { id:'h2bid-004', name:'City of Houston — Professional Engineering Services WW Regulatory Compliance', agency:'H2bid', city:'Houston, TX', due:'2026-10-01', scope:'Professional Engineering Services for regulatory permitting and compliance at various WWTP facilities. TPDES permit renewals, storm water, air permitting, laboratory coordination. Houston Public Works.', url:'https://www.beaconbid.com/solicitations/city-of-houston/bdccdb58-0dc2-45dc-9e43-d1c35f2d8b40/professional-engineering-services-for-regulatory-compliance-support-at-various-wastewater-facilities', source:'H2bid', scrapedAt:dates[5] },
    { id:'h2bid-005', name:'City of Houston — Water Distribution Repair & Improvement Program RFQ-2026-0002', agency:'H2bid', city:'Houston, TX', due:'2026-10-10', scope:'Program management, engineer-led programmatic design-build, design, construction management for Houston Water Distribution Program. Systematic rehabilitation of aging water distribution infrastructure. Houston Public Works.', url:'https://www.beaconbid.com/solicitations/city-of-houston/334da38b-c084-4235-a3d9-2e31155fcde7/water-distribution-repair-and-improvement-program', source:'H2bid', scrapedAt:dates[6] },
    { id:'h2bid-006', name:'City of Houston — Lift Station Renewal & Rehabilitation CB-2026-0026', agency:'H2bid', city:'Houston, TX', due:'2026-10-20', scope:'Lift Station Renewal and Rehabilitation — Green Dolphin, Sherwood Oaks, West subdivisions. Houston Public Works electrical and mechanical engineering.', url:'https://www.beaconbid.com/solicitations/city-of-houston', source:'H2bid', scrapedAt:dates[8] },
    { id:'h2bid-007', name:'City of Houston — WW Process Unit Cleaning & Evaluation CB-2026-0029', agency:'H2bid', city:'Houston, TX', due:'2026-10-30', scope:'Wastewater Process Unit Cleaning and Evaluation. Houston Public Works wastewater treatment engineering services CB-2026-0029.', url:'https://www.beaconbid.com/solicitations/city-of-houston', source:'H2bid', scrapedAt:dates[9] },
  ];
})()
