...
const H2BID_BIDS = (function() {
  ...
  return [
    { id:'h2bid-001', name:'City of Houston — WW Collection System Rehabilitation & Renewal (CB-2026-0048)', agency:'H2bid', city:'Houston, TX', due:'2026-09-15', scope:'City of Houston on-call services for rehabilitation and renewal of wastewater collection system. Point repairs, sewer replacement, CIPP, manholes, pavement. Est. $4,300,000. Bid CB-2026-0048.', url:'https://www.govcb.com/texas/city-of-houston/CB-2026-0048-wastewater-collection-system-rehabilitation-renewal.htm', source:'H2bid', scrapedAt:dates[0] },
    { id:'h2bid-002', name:'City of Houston — WW Collection System Rehabilitation of Manholes (CB-2026-0030)', agency:'H2bid', city:'Houston, TX', due:'2026-09-20', scope:'City of Houston rehabilitation of existing manholes using cementitious liners, cured-in-place liners and polymeric coatings. Point repairs to sewer mains at manhole connections. Bid CB-2026-0030.', url:'https://www.govcb.com/texas/city-of-houston/CB-2026-0030-wastewater-collection-system-rehabilitation-manholes.htm', source:'H2bid', scrapedAt:dates[2] },
    { id:'h2bid-003', name:'City of Houston — WW Collection System Rehabilitation & Renewal (CB-2026-0031)', agency:'H2bid', city:'Houston, TX', due:'2026-09-25', scope:'City of Houston Wastewater Collection System Rehabilitation and Renewal. E-BID. Bid CB-2026-0031. Houston Public Works.', url:'https://www.govcb.com/statebrowse/state.bid-Texas-City%20of%20Houston', source:'H2bid', scrapedAt:dates[3] },
    { id:'h2bid-004', name:'City of Houston — Lift Station Renewal & Rehabilitation (CB-2026-0026)', agency:'H2bid', city:'Houston, TX', due:'2026-10-01', scope:'City of Houston Lift Station Renewal and Rehabilitation — Green Dolphin, Sherwood Oaks, West subdivisions. E-BID. Bid CB-2026-0026.', url:'https://www.govcb.com/statebrowse/state.bid-Texas-City%20of%20Houston', source:'H2bid', scrapedAt:dates[5] },
    { id:'h2bid-005', name:'City of Houston — Sims North WW Treatment Plant Improvements Package 3 (CB-2026-0022)', agency:'H2bid', city:'Houston, TX', due:'2026-10-10', scope:'City of Houston Sims North Wastewater Treatment Plant Improvements Package 3. E-BID. Houston Public Works water treatment engineering.', url:'https://www.govcb.com/statebrowse/state.bid-Texas-City%20of%20Houston', source:'H2bid', scrapedAt:dates[6] },
    { id:'h2bid-006', name:'City of Houston — WW Process Unit Cleaning & Evaluation (CB-2026-0029)', agency:'H2bid', city:'Houston, TX', due:'2026-10-20', scope:'City of Houston Wastewater Process Unit Cleaning and Evaluation. E-BID Due Date: 7/9/2026. Houston Public Works wastewater engineering services.', url:'https://www.govcb.com/statebrowse/state.bid-Texas-City%20of%20Houston', source:'H2bid', scrapedAt:dates[8] },
    { id:'h2bid-007', name:'Harris County — Procurement Services Water/WW Engineering Bids', agency:'H2bid', city:'Harris County, TX', due:'2026-10-30', scope:'Harris County Procurement Services water and wastewater engineering bids. Open bids for Harris County MUD and municipal utility district projects. No login required.', url:'https://purchasing.harriscountytx.gov/Services/Bids-Proposals', source:'H2bid', scrapedAt:dates[9] },
  ];
})()
