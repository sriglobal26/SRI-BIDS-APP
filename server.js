...
const EBN_BIDS = [
  { id:'ebn-882894', name:'City of Liberty Hill — North Fork WWTP Improvements (882894)', agency:'City of Liberty Hill', city:'Liberty Hill, TX', posted:'2026-09-04', due:'2026-10-15', scope:'North Fork Wastewater Treatment Plant — new primary and secondary headworks, MBR treatment process. Electrical, instrumentation, controls, SCADA. 6 bid specifications available. Addenda 1-2, Due Date Extended.', url:'https://www.envirobidnet.com', source:'EnviroBidNet', value:'TBD', status:'active', region:'texas' },
  { id:'ebn-884913', name:'EBN — Bid Opportunity Alert for TX (884913)', agency:'Various Texas Agencies', city:'Texas', posted:'2026-09-05', due:'2026-09-20', scope:'New E&I engineering opportunity in Texas. See EnviroBidNet for full details and specifications.', url:'https://www.envirobidnet.com', source:'EnviroBidNet', value:'TBD', status:'active', region:'texas' },
  { id:'ebn-884038', name:'Opportunity Home San Antonio — RFQ Environmental Engineering Services (884038)', agency:'Opportunity Home San Antonio', city:'San Antonio, TX', posted:'2026-09-04', due:'2026-09-17', scope:'RFQ Addenda 1-2 Environmental Engineering Services for Opportunity Home San Antonio. 3 bid specifications available.', url:'https://www.envirobidnet.com', source:'EnviroBidNet', value:'TBD', status:'active', region:'texas' },
  { id:'ebn-883613', name:'Texas Facilities Commission — RFQ Engineering Site Services New Public Health Laboratory (883613)', agency:'Texas Facilities Commission (TFC)', city:'Austin, TX', posted:'2026-08-25', due:'2026-09-23', scope:'RFQ Addendum 1, Q&A — Engineering Site Services for New Public Health Laboratory. Civil Engineering all services. Bid No: 0010042. 1711 San Jacinto Blvd, Austin TX 78701.', url:'https://www.envirobidnet.com', source:'EnviroBidNet', value:'TBD', status:'active', region:'texas' },
]
const H2BID_BIDS = [
