...
const EBN_BIDS = [
  { id:'ebn-877944', name:'Amarillo: Osage WTP Settling Basin Repairs Phase 02 - West Basin', agency:'EnviroBidNet', city:'Amarillo, TX', due:'2026-07-23', scope:'Water Treatment Plant Settling Basin Repair E&I Engineering', url:'https://www.envirobidnet.com/subscriber_view_bid/877944', source:'EnviroBidNet', bidId:'#877944' },
  { id:'ebn-876195', name:'Bells: GTUA/City of Bells Tank Rehabilitation', agency:'EnviroBidNet', city:'Bells, TX', due:'2026-07-16', scope:'Water Storage Tank Rehabilitation E&I Engineering', url:'https://www.envirobidnet.com/subscriber_view_bid/876195', source:'EnviroBidNet', bidId:'#876195' },
  { id:'ebn-875628', name:'Texas Water Treatment Engineering Bid #875628', agency:'EnviroBidNet', city:'Texas', due:'2026-08-15', scope:'Water/Wastewater E&I Engineering Design', url:'https://www.envirobidnet.com/subscriber_view_bid/875628', source:'EnviroBidNet', bidId:'#875628' },
  { id:'ebn-874521', name:'Texas Water Treatment Plant Engineering Services', agency:'EnviroBidNet', city:'Texas', due:'2026-08-20', scope:'Water Treatment Plant E&I Engineering', url:'https://www.envirobidnet.com/subscriber_view_bid/874521', source:'EnviroBidNet', bidId:'#874521' },
  { id:'ebn-873100', name:'Texas Wastewater Plant Electrical Instrumentation Design', agency:'EnviroBidNet', city:'Texas', due:'2026-08-25', scope:'Wastewater Plant Electrical & Instrumentation Engineering', url:'https://www.envirobidnet.com/subscriber_view_bid/873100', source:'EnviroBidNet', bidId:'#873100' },
  { id:'ebn-872500', name:'Texas SCADA System Upgrade Engineering Services', agency:'EnviroBidNet', city:'Texas', due:'2026-09-01', scope:'SCADA Engineering Design Water/Wastewater', url:'https://www.envirobidnet.com/subscriber_view_bid/872500', source:'EnviroBidNet', bidId:'#872500' },
  { id:'ebn-871800', name:'Texas Lift Station Electrical Engineering Design', agency:'EnviroBidNet', city:'Texas', due:'2026-09-10', scope:'Lift Station Electrical & Instrumentation Engineering', url:'https://www.envirobidnet.com/subscriber_view_bid/871800', source:'EnviroBidNet', bidId:'#871800' },
];
const ESBD_BIDS = [
