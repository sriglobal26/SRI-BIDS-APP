...
async function initDB() {
  ...
  try {
    const d = await pool.query(`DELETE FROM bids WHERE data->>'source'='FedBids' AND id NOT IN ('fedbid-001','fedbid-002','fedbid-003','fedbid-004','fedbid-005','fedbid-006')`);
