...
const H2BID_BIDS = (function() {
  ...
  return [
    { id:'h2bid-001', name:'City of Houston — WW Collection System Rehabilitation & Renewal (CB-2026-0048)', agency:'H2bid', city:'Houston, TX', due:'2026-09-15', scope:'City of Houston on-call services for rehabilitation and renewal of wastewater collection system. Point repairs, sewer replacement, CIPP, cleaning and televising sanitary sewers. Est. value: $4,300,000.', url:'https://purchasing.houstontx.gov/Purchasing/OpportunityDetail?BidID=CB-2026-0048', source:'H2bid', scrapedAt:dates[0] },
    { id:'h2bid-002', name:'City of Houston — WW Collection System Rehabilitation Manholes (CB-2026-0030)', agency:'H2bid', city:'Houston, TX', due:'2026-09-20', scope:'City of Houston rehabilitation of existing manholes using cementitious liners, CIPP liners and polymeric coatings. Point repairs to sewer mains and laterals at manhole connections.', url:'https://purchasing.houstontx.gov/Purchasing/OpportunityDetail?BidID=CB-2026-0030', source:'H2bid', scrapedAt:dates[2] },
    { id:'h2bid-003', name:'HPW — Neighborhood Water Line Rehabilitation Central Park & Magnolia Park', agency:'H2bid', city:'Houston, TX', due:'2026-09-25', scope:'Houston Public Works Neighborhood Water Line Rehabilitation in Central Park and Magnolia Park Subdivisions. Harris County, TX.', url:'https://purchasing.houstontx.gov', source:'H2bid', scrapedAt:dates[3] },
    { id:'h2bid-004', name:'HPW — New Replacement Water Well & Collection Line IAH Well No. 4', agency:'H2bid', city:'Houston, TX', due:'2026-10-01', scope:'Houston Public Works New Replacement of Water Well and Well Collection Line IAH Well No. 4 — 60% Submittal. Harris County, TX.', url:'https://purchasing.houstontx.gov', source:'H2bid', scrapedAt:dates[5] },
    { id:'h2bid-005', name:'HCMUD No. 525 — Water Plant No. 1 Expansion to serve Sundance Cove', agency:'H2bid', city:'Harris County, TX', due:'2026-10-10', scope:'Harris County MUD No. 525 Water Plant No. 1 Expansion to serve Sundance Cove subdivision. Water treatment plant engineering and construction.', url:'https://app.civcast.com/bid-opportunities/projects', source:'H2bid', scrapedAt:dates[6] },
    { id:'h2bid-006', name:'Trinity River Authority — RFQ Professional Services FY 2027-2028', agency:'H2bid', city:'Arlington, TX', due:'2026-10-20', scope:'Trinity River Authority Request for Qualifications for Professional Services Fiscal Years 2027-2028. Water/Wastewater engineering services.', url:'https://www.civcastusa.com/publishers/5d6017908289a31a1c7febe1', source:'H2bid', scrapedAt:dates[8] },
    { id:'h2bid-007', name:'City of Pflugerville — WW2401 Gilleland Creek WW Interceptor (RFP 2026-023)', agency:'H2bid', city:'Pflugerville, TX', due:'2026-10-30', scope:'City of Pflugerville RFP No. 2026-023 — WW2401 Gilleland Creek Wastewater Interceptor Engineering Design Services.', url:'https://www.civcastusa.com/publishers/5867827b01ec5a264c779277', source:'H2bid', scrapedAt:dates[9] },
  ];
})()
