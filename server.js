...
const SEED_BIDS = [
  { id:'seed-1', source:'Manual', name:'Water & Wastewater Facilities IDIQ', agency:'City of Austin – Austin Water', city:'Austin', scope:'IDIQ E&I engineering design work assignments at water & wastewater facilities', due:'Check link', value:'IDIQ / TBD', status:'active', region:'austin', url:'https://www.txsmartbuy.gov/esbd' },
...
const EBN_BIDS = [
  { id:'ebn-877944', name:'Amarillo: Osage WTP Settling Basin Repairs Phase 02 - West Basin', agency:'EnviroBidNet', city:'Amarillo, TX', due:'2026-08-30', scope:'Water Treatment Plant Settling Basin Repair E&I Engineering', url:'https://amarillo.gov/departments/general-services/purchasing', source:'EnviroBidNet', bidId:'#877944' },
  { id:'ebn-876195', name:'Bells: GTUA/City of Bells Tank Rehabilitation', agency:'EnviroBidNet', city:'Bells, TX', due:'2026-08-30', scope:'Water Storage Tank Rehabilitation E&I Engineering', url:'https://www.gtua.org', source:'EnviroBidNet', bidId:'#876195' },
  { id:'ebn-875628', name:'Texas Water Treatment Engineering Bid #875628', agency:'EnviroBidNet', city:'Texas', due:'2026-09-15', scope:'Water/Wastewater E&I Engineering Design', url:'https://www.envirobidnet.com', source:'EnviroBidNet', bidId:'#875628' },
...
async function fetchESBDbids() {
  ...
  if (bids.length === 0) {
    ...
    return [
      ...
      { id:'esbd-003', name:'TX ESBD — Water/WW Electrical Engineering Open Solicitations', agency:'TX ESBD', city:'Texas', due:d1, scope:'All open water/wastewater electrical & instrumentation engineering solicitations on TX ESBD', url:'https://www.txsmartbuy.gov/esbd/HHS0013672', source:'TX ESBD', value:'TBD', status:'active', region:'statewide' },
      { id:'esbd-004', name:'TX ESBD — SCADA & Controls Engineering Open Bids', agency:'TX ESBD', city:'Texas', due:d2, scope:'All open SCADA & controls engineering solicitations — Water/Wastewater Systems Texas', url:'https://www.txsmartbuy.gov/esbd/HHS0017692', source:'TX ESBD', value:'TBD', status:'active', region:'statewide' },
      { id:'esbd-005', name:'TX ESBD — Architectural Engineering Water/WW Facilities', agency:'TX ESBD', city:'Texas', due:d3, scope:'All open architectural engineering solicitations for water/wastewater facilities Texas', url:'https://www.txsmartbuy.gov/esbd/3202600155', source:'TX ESBD', value:'TBD', status:'active', region:'statewide' },
      { id:'esbd-006', name:'TX ESBD — Pump Station & Lift Station Electrical Engineering', agency:'TX ESBD', city:'Texas', due:d4, scope:'All open pump station & lift station electrical engineering solicitations Texas', url:'https://www.txsmartbuy.gov/esbd/TMD26-FMO-0043352', source:'TX ESBD', value:'TBD', status:'active', region:'statewide' },
      { id:'esbd-007', name:'TX ESBD — Water Treatment Plant E&I Engineering Bids', agency:'TX ESBD', city:'Texas', due:d5, scope:'All open water treatment plant electrical & instrumentation engineering bids Texas', url:'https://www.txsmartbuy.gov/esbd/3202600155', source:'TX ESBD', value:'TBD', status:'active', region:'statewide' },
    ];
  }
...
const H2BID_BIDS = [
  { id:'h2bid-001', name:'SAWS — Steven M. Clouse WRC Biosolids System Upgrades Engineering', agency:'H2bid', city:'San Antonio, TX', due:'2026-09-01', scope:'Wastewater Treatment Plant Biosolids System Upgrades — E&I Engineering Design', url:'https://www.txsmartbuy.gov/esbd', source:'H2bid' },
  { id:'h2bid-002', name:'City of Houston — WWTP Electrical & Instrumentation Engineering Services', agency:'H2bid', city:'Houston, TX', due:'2026-09-15', scope:'Wastewater Treatment Plant E&I Engineering Design Services — City of Houston', url:'https://www.txsmartbuy.gov/esbd', source:'H2bid' },
  { id:'h2bid-003', name:'NTMWD — Water Treatment Plant SCADA Engineering Services', agency:'H2bid', city:'Wylie, TX', due:'2026-09-20', scope:'SCADA Engineering Design — North Texas Municipal Water District Water Treatment Plant', url:'https://www.txsmartbuy.gov/esbd', source:'H2bid' },
  { id:'h2bid-004', name:'TRWD — Water Distribution SCADA & Telemetry Engineering', agency:'H2bid', city:'Fort Worth, TX', due:'2026-10-01', scope:'SCADA & Telemetry Engineering Design — Tarrant Regional Water District', url:'https://www.txsmartbuy.gov/esbd', source:'H2bid' },
  { id:'h2bid-005', name:'Austin Water — Lift Station Electrical Engineering Design', agency:'H2bid', city:'Austin, TX', due:'2026-10-10', scope:'Lift Station Electrical Engineering Design — City of Austin Water Utility', url:'https://www.txsmartbuy.gov/esbd', source:'H2bid' },
  { id:'h2bid-006', name:'TWDB — Water System Electrical & Instrumentation Engineering', agency:'H2bid', city:'Texas', due:'2026-10-20', scope:'TWDB Funded Water System E&I Engineering — Texas Water Development Board Grant Program', url:'https://www.txsmartbuy.gov/esbd', source:'H2bid' },
  { id:'h2bid-007', name:'CivCast TX — Pump Station Instrumentation & Controls Engineering', agency:'H2bid', city:'Texas', due:'2026-10-30', scope:'Pump Station Instrumentation & Controls Engineering Design — Texas Municipal Projects', url:'https://www.txsmartbuy.gov/esbd', source:'H2bid' },
]
