...
const H2BID_BIDS = (function() {
  ...
  return [
    { id:'h2bid-001', name:'City of Pflugerville — WW2401 Gilleland Creek Wastewater Interceptor (RFP 2026-023)', agency:'H2bid', city:'Pflugerville, TX', due:'2026-09-15', scope:'City of Pflugerville RFP No. 2026-023 — WW2401 Gilleland Creek Wastewater Interceptor Engineering Design Services. Full bid details on CivCast — click Bid Link to view.', url:'https://app.civcast.com/bid-opportunities/projects', source:'H2bid', scrapedAt:dates[0] },
    { id:'h2bid-002', name:'Trinity River Authority TX — Water/WW Engineering Services', agency:'H2bid', city:'Arlington, TX', due:'2026-09-20', scope:'Trinity River Authority of Texas — Electrical & Instrumentation Engineering for Water/WW Treatment Facilities. Full details on CivCast publisher page.', url:'https://www.civcastusa.com/publishers/5d6017908289a31a1c7febe1', source:'H2bid', scrapedAt:dates[2] },
    { id:'h2bid-003', name:'Quiddity Engineering TX — Water Treatment E&I Engineering Services', agency:'H2bid', city:'Texas', due:'2026-09-30', scope:'Quiddity Engineering Texas — Water Treatment Electrical & Instrumentation Engineering Services. Full bid details on CivCast publisher page.', url:'https://www.civcastusa.com/publishers/5867827b01ec5a264c779277', source:'H2bid', scrapedAt:dates[3] },
    { id:'h2bid-004', name:'BidNet TX — Wastewater Treatment Plant Improvements Engineering', agency:'H2bid', city:'Texas', due:'2026-10-10', scope:'Texas Wastewater Treatment Plant Improvements — Full bid details, specs and documents on BidNet Direct. Open government bid.', url:'https://www.bidnetdirect.com/texas/solicitations/open-bids/statewide/Wastewater-Treatment-Plants-Improvements/444120606309', source:'H2bid', scrapedAt:dates[5] },
    { id:'h2bid-005', name:'HPW — Neighborhood Water Line Rehabilitation Central Park & Magnolia Park', agency:'H2bid', city:'Houston, TX', due:'2026-10-15', scope:'City of Houston HPW — Neighborhood Water Line Rehabilitation in Central Park and Magnolia Park Subdivisions. Harris County TX.', url:'https://app.civcast.com/bid-opportunities/projects', source:'H2bid', scrapedAt:dates[6] },
    { id:'h2bid-006', name:'HPW — New Replacement of Water Well & Collection Line IAH Well No. 4', agency:'H2bid', city:'Houston, TX', due:'2026-10-20', scope:'City of Houston HPW — New Replacement of Water Well and Well Collection Line IAH Well No. 4. Harris County TX. 60% Submittal.', url:'https://app.civcast.com/bid-opportunities/projects', source:'H2bid', scrapedAt:dates[8] },
    { id:'h2bid-007', name:'HPW — Transportation & Drainage Operations Bridge Rehabilitation', agency:'H2bid', city:'Houston, TX', due:'2026-10-30', scope:'City of Houston HPW — Transportation and Drainage Operations Bridge Rehabilitation and Replacement Program. Harris County TX.', url:'https://app.civcast.com/bid-opportunities/projects', source:'H2bid', scrapedAt:dates[9] },
  ];
})()
